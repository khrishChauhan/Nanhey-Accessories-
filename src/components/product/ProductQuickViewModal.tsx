      ...
      <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-200">
        ...
        <div className="bg-slate-900 px-6 py-4 text-white flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-bold uppercase tracking-wider bg-brand-red px-2 py-0.5 rounded text-white">
              {product.brand}
            </span>
        ...
        <div className="p-6 max-h-[80vh] overflow-y-auto space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
            ...
            <div className="md:col-span-5 space-y-3">
              <div className="relative flex h-52 w-full items-center justify-center rounded-2xl bg-slate-50 border border-slate-200 p-4">
                <Cctv className="h-24 w-24 text-slate-700" />
                {product.discount && (
                  <span className="absolute top-3 left-3 bg-brand-red text-white text-xs font-black px-2 py-0.5 rounded shadow-sm">
                    {product.discount}
                  </span>
                )}
                {product.isBestSeller && (
                  <span className="absolute top-3 right-3 bg-slate-900 text-white text-[10px] font-black px-2 py-0.5 rounded shadow-sm uppercase">
                    Best Seller
                  </span>
                )}
              </div>
              ...
              <div className="rounded-xl bg-slate-50 p-3 border border-slate-200 text-xs space-y-2">
                <div className="flex items-center gap-2 text-slate-700 font-semibold">
                  <ShieldCheck className="h-4 w-4 text-brand-accent-green" />
            ...
            <div className="md:col-span-7 space-y-3">
              ...
              <div className="flex items-baseline gap-2.5 pt-1">
                ...
                <span className="text-xs font-bold text-brand-accent-green">
                  {product.discount}
                </span>
              </div>

              {/* Stock Status */}
              <div className="flex items-center gap-1.5 text-xs font-bold text-brand-accent-green">
                ...
                <div className="grid grid-cols-2 gap-1 text-[11px] text-slate-600">
                  {product.features.map((feat, i) => (
                    <div key={i} className="flex items-center gap-1">
                      <Check className="h-3 w-3 text-brand-red shrink-0" />
              ...
              <div className="pt-3 border-t border-slate-100 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center rounded-xl border border-slate-300 bg-white">
                    <button
                      ...
                      className="p-2 hover:bg-slate-100 rounded-l text-slate-600 transition-colors"
                    ...
                    <button
                      ...
                      className="p-2 hover:bg-slate-100 rounded-r text-slate-600 transition-colors"
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-xs font-bold uppercase tracking-wider transition-all shadow-md ${
                      justAdded
                        ...
                        : "bg-brand-red text-white hover:bg-brand-red-600 shadow-brand-red/30 active:scale-95"
                    }`}
                  >
                    {justAdded ? (
                      <>
                  ...
                  <button
                    ...
                    className={`p-2.5 rounded-xl border transition-colors ${
                      wishlisted
                        ...
                        : "bg-white border-slate-200 text-slate-600 hover:text-brand-red"
                    }`}
                    title={wishlisted ? "Remove from wishlist" : "Add to wishlist"}
                  >
                    <Heart
                      className={`h-4 w-4 ${wishlisted ? "fill-brand-red" : ""}`}
                    />
                  </button>
                </div>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border border-emerald-300 font-bold text-xs py-2 rounded-xl transition-colors"
                >
