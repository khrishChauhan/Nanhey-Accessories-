...
export default function TopBar() {
  ...
  return (
    <div className="bg-zinc-950 text-zinc-400 text-[11px] h-[30px] flex items-center border-b border-zinc-900/80 px-3 sm:px-4 relative z-40">
      <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
        {/* Mobile View (< 640px): Phone on left, Language switcher on right (no address bloat) */}
        <div className="flex sm:hidden items-center justify-between w-full">
          <a
            href="tel:+919065224224"
            className="flex items-center gap-1.5 text-zinc-300 text-[11px] font-medium hover:text-red-400 transition-colors"
          >
          ...
          {/* Language Switcher */}
          <div className="inline-flex items-center bg-zinc-900 border border-zinc-800 rounded-full p-0.5 text-[10px]">
            <button
        ...
        {/* Desktop View (>= 640px): Left location/hours, Right phone & language */}
