      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3.5 sm:gap-4">
          {categories.map((cat) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-slate-50 text-slate-800 border border-slate-100 group-hover:bg-brand-red group-hover:text-white group-hover:shadow-lg group-hover:shadow-brand-red/30 transition-all duration-300 mt-2 mb-3">
                  <Icon className="h-8 w-8 stroke-[1.75]" />
                </div>

                {/* Category Name & Count */}
                <h3 className="font-bold text-sm text-slate-900 group-hover:text-brand-red transition-colors line-clamp-1">
                  {cat.name}
                </h3>
          ...
          >
            ...
            <h3 className="font-black text-sm text-brand-red group-hover:text-white transition-colors">
              VIEW ALL
            </h3>
